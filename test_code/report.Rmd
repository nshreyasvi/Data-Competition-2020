...
If,
$$
  \sum_{i=1}^n wi.xi> Θ, y=1,else,0
$$
Here $Θ$ is a real number called threshold, $wi$ are the weights and $xi$ are the features, $y$ is the prediction label as a factor.
```{r, echo=FALSE}
rm(list=ls())
library(caret)
library(C50)
